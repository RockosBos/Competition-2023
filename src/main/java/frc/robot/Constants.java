...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final class FrontLeftMod { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(267.3); //273.3
        ...
        public static final class FrontRightMod { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(170.7);   //3.7
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
